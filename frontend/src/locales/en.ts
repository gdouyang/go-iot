export default {
  ...
  agent: {
    ...
    composerPlaceholder: 'Describe the product, thing model, or codec, or attach hardware docs',
    uploadDoc: 'Attach Doc / Log',
    uploadDocTip: 'Supports .md, .txt, .json, .js, .csv, .log, max 64KB per file',
    fileTooLarge: 'File exceeds 64KB limit. Please keep only the protocol or key log section.',
    unsupportedFileType: 'Only text or log files (.md, .txt, .json, .js, .csv, .log) are supported',
    maxFilesExceeded: 'Maximum {max} files allowed at once',
    ...
    viewCollector: 'View point table',
    hideCollector: 'Hide point table',
    previewOld: 'Current',
    previewNew: 'Incoming',
