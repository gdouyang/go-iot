export default {
  ...
  agent: {
    notConfigured: '请先配置 AI 模型',
    goConfigure: '去配置',
    newChat: '新建会话',
    selectOrCreate: '选择或新建会话',
    config: '配置',
    send: '发送',
    continue: '继续',
    thinking: '思考中',
    ...
    composerPlaceholder: '描述要接入的产品、物模型或编解码，或上传硬件说明文档',
    uploadDoc: '上传文档/日志',
    uploadDocTip: '支持 .md, .txt, .json, .js, .csv, .log，单文件最大 64KB',
    fileTooLarge: '文件大小超过 64KB 限制，建议仅保留通信协议/数据点/关键日志部分',
    unsupportedFileType: '仅支持文本协议或日志文件（.md, .txt, .json, .js, .csv, .log）',
    maxFilesExceeded: '最多同时附加 {max} 个文件',
    fileReadError: '读取文件失败: {name}',
    deleteConv: '删除会话',
    deleteConvConfirm: '确定删除该会话？删除后不可恢复。',
    renameConv: '修改标题',
    renamePlaceholder: '请输入会话标题',
    resumeHint: '变更已应用，可继续完善物模型或编解码',
    emptyChat: '描述接入需求，助手会生成产品、物模型和编解码草稿',
    cancel: '停止',
    apply: '应用',
    reject: '拒绝',
    applied: '已应用',
    ...
    previewOld: '当前',
    previewNew: '将写入',
    previewTruncated: '预览已截断，完整内容请到产品页查看',
    previewPublished: '产品已发布：保存物模型可能变更时序表结构',
    tslSummary: '{props} 个属性 · {funcs} 个功能 · {events} 个事件',
    scriptSummary: '{n} 行'
  }
}
