...
- 添加模拟设备
![modbus_addmockdevice](static/img/modbus_addmockdevice.png)
- 添加寄存器
![modbus_addregister](static/img/modbus_addregister.png)
- 自动生成值
![modbus_addvaluegen](static/img/modbus_addvaluegen.png)
- 绑定值生成器
![modbus_bindvaluegen](static/img/modbus_bindvaluegen.png)
- 启动
![modbus_run](static/img/modbus_run.png)
