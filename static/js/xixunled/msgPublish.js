define({
    ...
    this.$refs.tinymceRef.destroy()
	}
    },
    template: `
    <my-dialog title="消息发布" ref="dialog1" @close="handleClose" @confirm="publish" 
      width="80%" :destroyOnClose="false">
      ...
      <el-col :span="12">
        ...
        <my-tinymce v-model="ruleForm.html" ref="tinymceRef" :config="{height:150}"/>
			</el-form-item>
		 </el-row>
		</el-form>
    </my-dialog>
