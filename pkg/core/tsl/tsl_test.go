...
func TestTsl(t *testing.T) {
	...
	assert.Equal(t, nil, d.Functions[0].Output)
	...
	assert.Equal(t, nil, d.Functions[1].Output)
	...
	assert.Equal(t, nil, d.Functions[2].Output)
	...
	assert.Equal(t, nil, d.Functions[3].Output)
